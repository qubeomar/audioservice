...
from qube.src.api.audioservicecontroller import audioserviceController
from qube.src.api.audioservicecontroller import audioserviceItemController
from qube.src.api.versioncontroller import audioserviceItemVersionController
...
api.add_resource(audioserviceItemVersionController, '/v1/audioservice/version')
api.add_resource(audioserviceController, '/v1/audioservice')
api.add_resource(audioserviceItemController, '/v1/audioservice/<string:entity_id>')
