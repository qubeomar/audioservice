...
from qube.src.api.swagger_models.audioservice import VersionModel
...
class audioserviceItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(audioserviceItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['audioservice'],
            'description': 'audioservice Version operation',
