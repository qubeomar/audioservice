...
HELLO_VERSION = "/v1/audioservice/version"
...
class TestaudioserviceVersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_audioservice_default_version(self, *args, **kwargs):
    ...
    def test_audioservice_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
